...
export const Contact = () => {
  ...
  const contactMethods = [
    {
      icon: Mail,
      contact: dictionary.contact.methods.email,
    },
    {
      icon: Phone,
      contact: dictionary.contact.methods.phone,
      href: "tel:+385915401195",
    },
    {
      icon: MapPin,
      contact: dictionary.contact.methods.address,
    },
  ];

  return (
    <main className="mt-16 sm:mt-32 py-8 sm:py-16 bg-slate-100" id="contact">
      <div className="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
        <div className="max-w-lg mx-auto justify-between lg:flex lg:max-w-none space-y-4 lg:space-y-0">
          <motion.div
          ...
          >
            <Card className="p-8 w-full lg:w-[450px] rounded-lg shadow-none">
              <SendEmailForm />
            </Card>
          </motion.div>
        </div>
